        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- form -->
                    <form action="buatuserbaru.php" method="post" name="add_user" enctype="multipart/form-data">
...
if (isset($_POST['add_user'])) {
    ...
    $result = mysqli_query($mysqli, "INSERT INTO `user` (`user_id`, `username`, `password`, `email`, `user_status`) VALUES (NULL, '$username', '$password', '$email', '1')");
